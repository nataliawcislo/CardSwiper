...
class StackContainerView: UIView, SwipeCardsDelegate {
    ...
    func reloadData() {
        ...
        for i in 0..<min(numberOfCardsToShow,cardsToBeVisible) {
            //let newIndex = Int.random(in: 0..<datasource.numberOfCardsToShow())
    ...
    func swipeDidEnd(on view: SwipeCardView) {
        ...
        let newIndex = (datasource.numberOfCardsToShow() - remainingcards) % datasource.numberOfCardsToShow()
        //let newIndex = Int.random(in: 0..<datasource.numberOfCardsToShow())
